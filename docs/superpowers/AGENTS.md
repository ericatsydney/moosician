# AGENTS.md for docs/superpowers/

## Output style for planning and spec documents

When writing or updating any `.md` file under this directory tree:

- **Be concise.** Favor short descriptions over long paragraphs.
